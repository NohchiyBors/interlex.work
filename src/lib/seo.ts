...
const seoContent: Record<Locale, SeoContent> = {
  ...
  ru: {
    home: {
      ...
      searchLabel: "Какие задачи мы берем",
      searchTitle: "Регистрация, спецрежимы, сделки и инвестиционные маршруты в одном контуре.",
      searchIntro:
        "InterLex нужен, когда бизнесу или инвестору надо не просто открыть компанию, а собрать всю логику входа: страну, режим, структуру, сделку, due diligence и дальнейшее сопровождение. Ниже — типовые маршруты, с которыми к нам приходят до перехода в локальную практику.",
      searchCards: [
        {
          title: "Казахстан: регистрация, СЭЗ, AIFC",
          body: "Регистрация компании, специальные режимы, налоги, банковский контур и подготовка к полноценному запуску в Казахстане.",
        },
        {
          title: "Грузия: LLC, Virtual Zone, FIZ",
          body: "Быстрый вход в Грузию через подходящий режим, налоговую модель и структуру для IT, сервисного и международного бизнеса.",
        },
        {
          title: "M&A и Due Diligence",
          body: "Покупка компаний и активов, скрининг цели, структура сделки, due diligence и переговорный контур до подписания.",
        },
        {
          title: "Инвесторам и GR",
          body: "Инвестиционные программы, преференции, рабочий диалог с профильными органами и сборка проекта до запуска или сделки.",
        },
      ],
      faqLabel: "FAQ",
