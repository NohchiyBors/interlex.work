...
const content: Record<Locale, ServiceScopeContent> = {
  ...
  ru: {
    ...
    intentBody:
      "Мы подключаемся, когда нужно выбрать юрисдикцию, запустить компанию, выстроить структуру владения, пройти банковские и налоговые вопросы, наладить бухгалтерское и юридическое сопровождение, а при необходимости подготовить инвестиционный проект, сделку или due diligence. Если вы планируете купить актив в Казахстане или Грузии, InterLex может взять на себя скрининг цели, проверку рисков, структурирование сделки и координацию переговоров, включая проекты, где требуется рабочее взаимодействие с государством.",
