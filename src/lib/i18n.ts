...
const dictionaries: Record<Locale, Dictionary> = {
  ...
  ru: {
    ...
    home: {
      ...
      primaryCta: "Открыть международные проекты",
      secondaryCta: "Узнать об InterLex",
      logicLabel: "Логика хаба",
      notes: [
        "Один бренд InterLex с отдельными направлениями по рынкам.",
        "Международная рамка остаётся на хабе, локальная работа — на сайте страны.",
      ...
      positioningTitle: "Международное юридическое и деловое сопровождение с ясной глобальной точкой входа.",
      ...
      sections: [
        ...
        { label: "Международные проекты", slug: "cross-border", title: "Как Казахстан и Грузия складываются в единую модель сопровождения.", body: "Эта страница помогает сориентироваться по выходу на рынок, структуре бизнеса, налоговой логике и операционной модели." },
    ...
    regionLinks: [
      ...
      },
      {
        name: "Грузия",
        ...sharedDomains[1],
        language: "Англоязычный сайт",
        strapline: "Структурирование, FIZ-пути, налоговая логика и международная поддержка в Грузии.",
        points: [
          "Для международных клиентов, которые сравнивают модели входа, холдинговую логику и региональные структуры.",
          "Подходит, когда важны режимы Грузии, англоязычное сопровождение и понятная структура для инвестора.",
