...
const localizedSalesContent: Record<Locale, SalesContent> = {
  ...
  ru: {
    label: "Пакеты / Цены",
    title: "Прозрачные цены и понятные форматы: пакет можно выбрать или собрать под проект.",
    intro:
      "На главной клиент должен сразу видеть понятные форматы сотрудничества: выход на рынок, международное структурирование и дальнейшее сопровождение. Старт возможен с пакета от $990 без скрытых платежей и бесконечных доплат «за каждый шаг». Если стандартный формат не подходит, InterLex адаптирует состав работ под ваш бизнес, рынок и темп запуска.",
    cta: "Начать за $990",
    packages: [
      {
        name: "Выход на рынок",
