        ...
        {dict.regionLinks.map((region, index) => (
          <article key={region.domain} className={`border px-6 py-7 ${index === 1 ? "border-[var(--primary)] bg-[var(--primary)] text-white" : "border-[color:rgba(0,9,36,0.08)] bg-white"}`}>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <a
                href={region.href}
                className={`inline-flex items-center justify-center border px-6 py-3 text-xs font-medium uppercase tracking-[0.18em] transition-colors ${index === 1 ? "border-white/18 bg-white text-[var(--primary)] hover:bg-white/92" : "border-[var(--primary)] bg-[var(--primary)] text-white hover:bg-[var(--primary-soft)]"}`}
              >
                {region.domain}
              </a>
              <a
      ...
      <section className="mt-6 border border-[color:rgba(0,9,36,0.08)] bg-[var(--surface-low)] px-6 py-8 md:px-8">
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center border border-[color:rgba(0,9,36,0.12)] bg-white px-6 py-3 text-xs font-medium uppercase tracking-[0.18em] text-[var(--primary)] transition-colors hover:bg-[var(--surface-low)]"
          >
